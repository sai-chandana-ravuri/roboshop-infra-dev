resource "aws_cloudfront_distribution" "roboshop" {
  origin {
    #Origin url
    domain_name              = "frontend-${var.project_name}-${var.environment}.${var.domain_name}"
    origin_id                = "frontend-${var.project_name}-${var.environment}.${var.domain_name}"
  ...
  default_cache_behavior {
    ...
    target_origin_id = "frontend-${var.project_name}-${var.environment}.${var.domain_name}"
